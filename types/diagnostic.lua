...
-- namespace.
--- @param opts #(table|nil) When omitted or "nil", retrieve the current
...
--- @param namespace #(number|nil) Only disable diagnostics for the given
---                  namespace.
...
--- @param namespace #(number|nil) Only enable diagnostics for the given
---                  namespace.
...
--- @param severity_map table #A table mapping the severity field from
---                     {groups} with an item from |vim.diagnostic.severity|.
--- @param defaults #(table|nil) Table of default values for any fields not
---                     listed in {groups}. When omitted, numeric values
---                     default to 0 and "severity" defaults to ERROR.
--- @return #diagnostic |diagnostic-structure| or `nil` if {pat} fails to match
---     {str}.
...
--- @param diagnostics #(table|nil) The diagnostics to display. When omitted,
